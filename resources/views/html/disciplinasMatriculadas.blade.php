    ...
    <div class="container" style="margin-top:30px">
        ...
        <div class="row rowElementos" >
            <div class="col-sm-3 discOp">  
                <div class="row">
                    <div class="col-sm-12">
                            <a href="#"><div id="opMenuDisc">Disciplinas Matriculadas</div></a>
                            <a href="#"><div id="opMenuDisc">Disciplinas Não Matriculadas</div></a>
            ...
            <div class="col-sm-9">
                    <div id="opDisciplina">
                        <a href="#"><h5>COD - Nome Disciplina - Professor Disciplina</h5></a>
